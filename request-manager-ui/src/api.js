...
export const authApi = {
    ...
    register: (firstname, lastname, email, username, password) =>
        apiClient.post('/auth/register', { firstname, lastname, email, username, password }),
    registerAdmin: (firstname, lastname, email, username, password) =>
        apiClient.post('/auth/registerAdmin', { firstname, lastname, email, username, password }),
};
...
export const requestApi = {
    ...
    updateTicket: (ticketID, ticketData) => apiClient.put(`/api/tickets/${ticketID}`, ticketData),
...
export const notificationApi = {
    ...
    createNotification: async (notificationData) => {
        try {
            ...
            console.error('Помилка при створеннні сповіщення:', error);
            throw error;
        }
    },
